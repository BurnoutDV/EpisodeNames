...
i18n = LanguageArchive({
    ...
    'Projects': "Projects",
    'Linking': "Linking",
    'title': "Title", # mostly table headings in linking screen dataview
    'views': "Views",
    'upload_date': "Upload Date",
    'publish_date': "Publish Date",
    'last_update': "Last Update",
    'last_full_update': "Last Full Update",
    ...
    'Assign Episode Template': "Assign Episode Template",
    ...
    'DL Playlist': "DL Playlist",
    'DL Videos': "DL Videos",
    'comma separated list': "comma separated list",
    'YT Channel ID': "YT Channel ID",
    'YT API Key': "YT API Key",
    'Video Title Filter Words': "Video Title Filter Words",
    'Project Title Filter Words': "Project Title Filter Words",
    'Filter Words': "Filter Words",
    'Database2JSON Export Partial': "Database2JSON Export Partial",
    'Youtube Linking': "Youtube Linking",
    'Dateformat': "Dateformat",
    'Datetimeformat': "Datetimeformat",
    'Transcriped YT Data': "Transcriped YT Data",
    ...
    'Edit Episode Description': "Edit Episode Description",
    'Edit Description Addon': "Edit Description Addon",
    ...
    'Couldnt reverse templating': "Couldn't reverse templating",
    'Episode Batch Linking': "Episode Batch Linking",
    ...
    'Confirm that you understand and have read': "Confirm that you understand and have read",

    'project: Create a new Project': "project: Create a new Project",
    'Project Note': "Project Note",
    'Delete Project': "🔥🔥Delete Project🔥🔥", # feeling edgy
    'Fetched n Videos': 'Fetched %%NUMBER%% Videos',
    ...
    #linking screen dataview filter words:
    '#, published': "#, published",
    'combo_words': "%%number%% words",
    'combo_chars': "%%number%% chars",
    'app: Debug Command': "app: Debug Command"
